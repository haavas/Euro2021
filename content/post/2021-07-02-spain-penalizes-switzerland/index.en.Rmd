...
projects: []
---
Penalty shootouts are won by the initiators. So, once the coin is tossed, the outcome is decided. Or something.
...
```
Not many had Spain in the Semis, but one of them is Sebastian, so we have a change in the lead! Sebastian is now ahead. Jacob is back in third, pushing Robert down to forth. 

Øyvind, Philipp L., Anne-Kathrin, Dag Harald, Dagfinn and Marit all had Spain through and is well rewarded for this.

```{r knock_37, echo = FALSE, warning=FALSE,  fig.height=10, fig.width=10}
poeng_prev <- tbl_df(read.csv("details44.csv", sep=";", header = FALSE))
