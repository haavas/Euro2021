---
title: 'Belgium is actually not winning '
author: HS
date: '2021-07-02'
slug: belgium-is-actually-not-winning
categories:
  - Game
tags:
  - Euro2021
...
summary: ''
authors: []
lastmod: '2021-07-02T23:10:05+02:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
Neither of the top two had Italy in the Semis, but today has been a great day for Jacob. He is now only 87 points behind the leading duo.

```{r knock_37, echo = FALSE, warning=FALSE,  fig.height=10, fig.width=10}
poeng_prev <- tbl_df(read.csv("details45.csv", sep=";", header = FALSE))
